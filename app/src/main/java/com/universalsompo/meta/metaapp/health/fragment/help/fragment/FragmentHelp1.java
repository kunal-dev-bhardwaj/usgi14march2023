...
import com.universalsompo.meta.metaapp.health.fragment.help.adapter.Help1Adapter;
...
public class FragmentHelp1 extends Fragment implements ResponseListener {
    private View v;
    ...
    private void callApi() {
        ...
        ProjectVolleyRequest req = new ProjectVolleyRequest(getActivity(), object, UrlHealthConstants.GET_HELP1, this, RequestHealthConstants.GET_HELP1);
        req.execute();
    }
        ...
        if (Tag == RequestHealthConstants.GET_HELP1){
            ...
            if (object.optString("Message").equals("Success")){
                ...
                try {
                    ...
                    Help1Adapter helpAdapter = new Help1Adapter(getActivity(), data, id_help1);
