...
public class StartHRA extends AsyncTask<String, String, HashMap<String, String>> implements ResponseListener {
    Context mContext;
    private MySharedPreference pref;
    private SelectorListener binder;
    private ProgressDialog mProgressDialog;

    public StartHRA(Context context, ProgressDialog mProgressDialog) {
...
//            mProgressDialog.show();
    ...
    protected HashMap<String, String> doInBackground(String... params) {
        ...
        if (!isCancelled()) {
            try {
                ...
                String strUrl ="https://core.allizhealthtest.in/PHR/api/PrimaryHRA/Start";
    ...
    protected void onPostExecute(HashMap<String, String> resultMap) {
        ...
        try {
            ...
            if(resultMap!=null && resultMap.size()>0){
                ...
                String json_str1 = json_data.getString("Template");
                JSONObject json_data1 = new JSONObject(json_str1);
                String json_str2 = json_data1.getString("ID");
                pref.settempid(json_str2);
                callApi(RequestHealthConstants.HRA_CHECK_STATUS);
                //replaceFragment(new FragmentBMI(), FragmentsHealthTags.FRAGMENT_HRA);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void callApi(Integer id) {
        if (id == RequestHealthConstants.HRA_CHECK_STATUS) {
            ...
            ProjectVolleyRequest2 req = new ProjectVolleyRequest2(mContext, object, UrlHealthConstants.HRA_CHECK_STATUS, this, RequestHealthConstants.HRA_CHECK_STATUS);
            req.execute();
        }
    }
    ...
    public void onSuccess(JSONObject object, int Tag) {
        if (Tag == RequestHealthConstants.HRA_CHECK_STATUS) {
            try {
