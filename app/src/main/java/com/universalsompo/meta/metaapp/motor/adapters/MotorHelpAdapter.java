...
import com.universalsompo.meta.metaapp.motor.fragments.FragmentMotorHelp1;
...
public class MotorHelpAdapter extends BaseAdapter implements ResponseListener {
    ...
    public MotorHelpAdapter(Activity activity, List<MotorHelp> help) {
    ...
    private void callApi(String mID) {
        ...
        ProjectVolleyRequest req = new ProjectVolleyRequest(activity, object, UrlConstants.GET_HELP1, this, RequestConstants.GET_HELP1);
        req.execute();
    }
    ...
    public void onSuccess(JSONObject object, int Tag) {
        if (Tag == RequestConstants.GET_HELP1) {
            if (object.optString("Message").equals("Success")) {
                Fragment frag = new FragmentMotorHelp1();
