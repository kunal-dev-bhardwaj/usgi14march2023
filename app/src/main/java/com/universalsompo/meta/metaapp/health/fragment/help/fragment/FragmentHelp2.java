...
import com.universalsompo.meta.metaapp.health.fragment.help.adapter.Help2Adapter;
...
public class FragmentHelp2 extends Fragment implements ResponseListener {
    private View v;
    ...
    private void callApi() {
        ...
        ProjectVolleyRequest req = new ProjectVolleyRequest(getActivity(), object, UrlHealthConstants.GET_HELP2, this, RequestHealthConstants.GET_HELP2);
        req.execute();
    }
        ...
        if (Tag == RequestHealthConstants.GET_HELP2){
            ...
            if (object.optString("Message").equals("Success")){
                ...
                try {
                    ...
                    Help2Adapter helpAdapter = new Help2Adapter(getActivity(), data, id_help1, id_help2);
