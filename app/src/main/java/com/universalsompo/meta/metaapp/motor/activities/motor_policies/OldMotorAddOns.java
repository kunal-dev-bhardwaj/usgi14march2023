...
public class OldMotorAddOns extends AppCompatActivity {
    String strContineuBtn;
    Dialog CNGalert_dialog;
    private SimpleDateFormat dateFormatter;
    int dayDifference;
    RelativeLayout relativeComp;
    LinearLayout TPLiner,IDVLinear, DrivingLiner, IndividualLiner, linerCenterBike, HighRiskLiner, LowRiskLiner, continue_button, BookNowLinerComprehensive, ThreeYearLiner, FiveYearLiner;
    LinearLayout relativeThird, OwnDamagedLiner, LinerPaidDriver, NamedLiner, UnnamedLiner, LinerAutoMobile, LinerPrivate, LinerTwo;
    String strIDTypeName1,NCBStatus,StrPrev_Policy_Type, AdditionalCoverBasicOdPremium, AdditionalBasicTpCoverPremium, strMinMax, ELECTRICALACCESSORYODSumInsured = "", VoluntarydeductableSumInsured = "", strElectricalAccessoriesSumInsured, AntitheftdevicediscountStatus, AutomobileAssociationdiscountStatus, TPPDDiscountStatus, HandicapDiscountStatus, VoluntarydeductableStatus, AdditionalNonElecticalODSumInsuredValue, AdditionalElectricalSumInsuredValue, AntitheftdeviceRateValue, AntitheftdeviceSumInsuredValue, AutomobileAssociationRateValue, AutomobileAssociationSumInsuredValue, HandicapRateValue, HandicapSumInsuredValue, TPPDDiscountRateValue, TPPDDiscountSumInsuredValue, VotaryRateValue, VotarySumInsuredValue, StrNCB, strDiscountEdit, DetarifficValueSumInsure = "", DetarifficLoadingValueSumInsured = "", BasicODRateSumInsured = "", ELECTRICALCoverSumInsured = "", NONELECTRICALSumInsured = "", BasicTpRateSumInsured = "", AdditionalFibertankODSumInsuredValue, AdditionalLegalLiabilityPaidSumInsured, AdditionalOtherODRateSumInsured, AdditionalOtherTpSumInsuredValue, AdditionalPaCoverToOwnerDriverSumInsuredValue, AdditionalPaidDriverSumInsuredValue, AdditionalPaToPassengersSumInsuredValue, AdditionalUnnamedPassengersSumInsuredValue, AdditionalCngKitODSumInsuredValue, AdditionalCngLpgTpSumInsuredValue, AdditionalBuiltinKitODSumInsuredValue, AdditionalBuiltinCngTPSumInsuredValue, DailyCashRateSumInsured, AccidentalSumInsuredValue, WrongFuelSumInsuredValue, CostOfConsumablesSumInsuredValue, dailyCashAllowanceMetroSumInsuredValue, dailyCashAllowanceNonMetroSumInsuredValue, EngineProtectorDieselSumInsuredValue, EngineProtectorPetrolSumInsuredValue, HydrostaticLockSumInsuredValue, KeyReplacementSumInsuredValue, NilDepreciationSumInsuredValue, ReturnToInvoiceSumInsuredValue, RoadSideAssistanceSumInsuredValue, SecureTowingSumInsuredValue, TyreRimsecureSumInsuredValue, drivingTrainProtectSumInsuredValue, ManufacturesellingSumInsuredValue, strNewFor, changeseekBar = "", CheckString = "", DAILYCASHALLOWANCEStatus = "", DetariffDiscountStatus = "", DetariffLoadingStatus = "", strPreviousClaimRadio = "", StrAdditionalCoverPremiumOD = "", StrAdditionalCoverPremiumTp = "", SeekbarStatus = "", vehicleManufacturerType = "", strModelType = "", nextYear, strCompanyName = "", CubicCapacity = "", FuleType = "", rc_cubic_cap = "", rc_fuel_desc = "", strVehicleEngineNumber = "", strVehicleChasisNumber = "", NumberOfWheels = "", VEHICLECLASSCODE = "", strClaimBonus = "", StrPreviousPolicyRadio = "", strEndDateEdit = "", ProductName = "", ProductCode = "", VehicleClassCode = "", addOns = "", addOnsCover = "", addOnsAditional = "", NCB = "", DetarifficValuePremium = "", DetarifficValueRate = "", StrDetarifficValuePremiumDouble = "", DetarifficLodingValuePremium = "", DetarifficLoadingValueRate = "", StrDetarifficLoadingValuePremiumDouble = "", AdditionalCoverPremium = "", PremiumValue = "", NetPremiumValue = "", VehicleExShowroomPrice = "", TotalValue = "", PosPolicyNo = "", GST = "", strIdvValueTxt = "", strIdvValueTxt1 = "", strIdvValueTxtSelect = "", strLessIDVText = "", strHighIDVText = "", today = "", tomorrowDate = "", strThirdDString = "", strVehicleAge = "", yearOfManufacture = "", strVehicleModelCode = "", strName = "", strVehicleNo = "", str_edt_city = "", str_edt_phone = "", str_edt_email = "", strPolicyRadio = "", strVehicleTypeRadio = "", strVehicleRadio = "", strFor = "", strVehicleManufacturerCode = "", strRTOCode = "", strRTOName = "", str_vehicleManufacturerNm = "", strStateName = "", strStateCode = "", str_edt_registration_date = "", strVehicleModel = "", strPolicyNumberEdit = "", strPlanYear = "", strPlanType = "", strCoverageType = "", strPACover = "", strGPACover = "", strDrivingLicence = "", BasicODStatus = "", BasicTP = "", ELECTRICALACCESSORYODStatus = "", FIBERTANKODStatus = "", LEGALLIABILITYTOPAIDDRIVERStatus = "", NONELECTRICALACCESSORYODStatus = "", OtherODStatus = "", OtherTpStatus = "", PACOVERTOEMPLOYEESOFINSUREDStatus = "", PACOVERTOOWNERDRIVERStatus = "", CNGLPGKITODStatus = "", CNGLPGKITTPStatus = "", BUILTINCNGKIT_LPGKITODStatus = "", MANUFACTURERSELLINGPRICEStatus = "", DRIVINGTRAINPROTECTStatus = "", PACOVERTOPAIDDRIVERStatus = "", PACOVERTOPASSENGERSStatus = "", UNNAMEDPACOVERTOPASSENGERSStatus = "", BUILTINCNGKIT_LPGKITTPStatus = "", ACCIDENTALHOSPITALIZATIONStatus = "", COSTOFCONSUMABLESStatus = "", DAILYCASHALLOWANCEMETROStatus = "", DAILYCASHALLOWANCENONMETROStatus = "", ENGINEPROTECTORDIESELStatus = "", WRONGFUELCOVERStatus = "", ENGINEPROTECTORPETROLStatus = "", HYDROSTATICLOCKCOVERStatus = "", KEYREPLACEMENTStatus = "", NilDepreciationWaivercoverStatus = "", RETURNTOINVOICEStatus = "", RoadsideAssistanceStatus = "", SECURETOWINGStatus = "", TyreandRimsecureStatus = "", strRegisteredAddressEdit = "", strTitleEdit = "", strStateRegisterAddressEdit = "", strStateRegisterCode, strCityRegisterCode = "", strCityRegisterEdit = "", strCityCommunicationCode = "", strPinCodeEditText = "", strCommunicationAddressEdit = "", strCommunicationPinCodeEdit = "", strStateCommunicationEdit = "", strStateCommunicationCode = "", strCityCommunicationEdit = "", strCheckedTermCondition = "", strCheckboxCommunication = "";
    String yearOfManufactureMonth,strSelectDateYear,ckycNo,uniqueTransactionNumber,strTpFromDateEdit,strTpEndDateEdit,strIdvValueEdit, DiscountsVale, ChangeAddons, strVehicleCubicCapicity = "", strVehicleImage = "", strVehicleNumber, BasicODRateValue = "", BasicTpRateValue = "", AdditionalElectricalRateValue = "", AdditionalFibertankODRateValue = "", AdditionalLegalLiabilityPaidRate = "", AdditionalLegalLiabilityDriverRateValue = "", AdditionalBuiltinCngTPRateValue = "", AdditionalNonElecticalODRateValue = "", AdditionalOtherODRateValue = "", AdditionalOtherTpRateValue = "", AdditionalPaCoversToEmployessRateValue = "", AdditionalPaCoverToOwnerDriverRateValue = "", AdditionalPaidDriverRateValue = "", AdditionalPaToPassengersRateValue = "", AdditionalUnnamedPassengersRateValue = "", AdditionalCngKitODRateValue = "", AdditionalCngLpgTpRateValue = "", AdditionalBuiltinKitODRateValue = "", DailyCashRateValue = "", AccidentalRateValue = "", CostOfConsumablesRateValue = "", WrongFuelRateValue = "", dailyCashAllowanceMetroRateValue = "", dailyCashAllowanceNonMetroRateValue = "", EngineProtectorDieselRateValue = "", EngineProtectorPetrolRateValue = "", HydrostaticLockRateValue = "", KeyReplacementRateValue = "", NilDepreciationRateValue = "", ReturnToInvoiceRateValue = "", RoadSideAssistanceRateValue = "", SecureTowingRateValue = "", TyreRimsecureRateValue = "", drivingTrainProtectRateValue = "", ManufacturesellingRateValue = "", strNomineeName = "", strNomineeRelationEdit = "";
    String AutoMobileValidityRadio, AutoMobileRadio, AutomobileAssociationdiscountSumInsured, strMemberEditTxt, strValidityTxt, strAntitheftdeviceDiscount = "", AutomobileAssociationDiscount = "", StrHandicapDiscount = "", StrTPPDDiscount = "", StrVotaryDeductablelun = "", PACOVERTOPAIDDRIVERSumInsured, PACOVERTOPASSENGERSSumInsured, UNNAMEDPACOVERTOPASSENGERSSumInsured, CNGLPGKITODSumInsured, strCngKitSumInsured, strNonelectricalAccessoriesSumInsured, NONELECTRICALACCESSORYODSumInsured, AntitheftdevicediscountStatus1, AutomobileAssociationdiscountStatus1, VoluntarydeductableStatus1, TPPDDiscountStatus1, HandicapDiscountStatus1, ELECTRICALACCESSORYODStatus1, NONELECTRICALACCESSORYODStatus1, PACOVERTOEMPLOYEESOFINSUREDStatus1, PACOVERTOPASSENGERSStatus1, PACOVERTOPAIDDRIVERStatus1, OtherTpStatus1, FIBERTANKODStatus1, OtherODStatus1, UNNAMEDPACOVERTOPASSENGERSStatus1, PACOVERTOOWNERDRIVERStatus1, CNGLPGKITODStatus1, CNGLPGKITTPStatus1, BUILTINCNGKIT_LPGKITODStatus1, MANUFACTURERSELLINGPRICEStatus1, BUILTINCNGKIT_LPGKITTPStatus1, DRIVINGTRAINPROTECTStatus1, LEGALLIABILITYTOPAIDDRIVERStatus1,
            RoadsideAssistanceStatus1, NilDepreciationWaivercoverStatus1, DAILYCASHALLOWANCENONMETROStatus1, DAILYCASHALLOWANCEMETROStatus1, KEYREPLACEMENTStatus1, RETURNTOINVOICEStatus1, ACCIDENTALHOSPITALIZATIONStatus1, HYDROSTATICLOCKCOVERStatus1, COSTOFCONSUMABLESStatus1, SECURETOWINGStatus1, TyreandRimsecureStatus1, ENGINEPROTECTORPETROLStatus1, ENGINEPROTECTORDIESELStatus1, DAILYCASHALLOWANCEStatus1, WRONGFUELCOVERStatus1, DetariffDiscountStatus1, DetariffLoadingStatus1,strBreaking = "",previousDate = "";
    ...
    TextView RecommendTxt, AntitheftPremiumTxt, AutomobilePremiumTxt, HandicapPremiumTxt, TPPDPremiumTxt, VotaryPremiumTxt, saveTxt, ViewDetails, TxtViewVehicleType, BasicODPremiumTxt, BasicTPPremiumTxt, ElectricalPremiumTxt, FIBERTANKPremiumTxt, LegalPremiumTxt, NonElectricalPremiumTxt, OtherOdPremiumTxt, OtherTpPremiumTxt, EmployeesInsuredPremiumTxt, OwnerDriverPremiumTxt, PaidDriverPremiumTxt, DailyCashAllowancePremium, WrongFuelTxtPremium, PassengersPremiumTxt, UnnamedPassengersPremiumTxt, CNGLPGKITODPremiumTxt, CNGLPGKITTPPremiumTxt, BUILTINCNGKITPremiumTxt, BuiltinCngLPGTpPremiumTxt, ManufacturePricePremiumTxt, CoverAddOnText, CoverAdditionalText, VehicleNameText, clcikTpTxt, clcikODTxt, VehicleNumberText, IdvValueTxt, clcikMy, lessIDVText, HighIDVText, IDVTotalPremium, TotalPremium, AccidentalHospitalPremium, CostOfConsumableNamePremium, DailyCashAllowanceNamePremium, DailyCashNonMetroPremium, EngineProtectorDieselPremium, EngineProtectorPetrolPremium, HydrostaticeLockcoverPremium, KeyReplacementPremium, NilDepreciationWaivercoverNamePremium, ReturnToInvoicePremium, RoadsideAssistancePremium, SecureTowingPremium, TyreAndRimSecurePremium, DrivingTrainProtectPremium, AccidentalHospitalRemoveButton,
            DailyCashAllowanceAddButton, DailyCashAllowanceRemoveButton, wrongFuelAddButton, WrongFuelRemoveButton, AccidentalHospitalAddButton, CostOfConsumableAddButton, CostOfConsumableRemoveButton, DailyCashAddButton, DailyCashRemoveButton, DailyCashNonADDButton, DailyCashNonRemoveButton, EngineAddButton, EngineRemoveButton, ENGINEPetrolAddButton, ENGINEPetrolRemoveButton, HydrostaticAddButton, HydrostaticRemoveButton, KeyReplacementAddButton, KeyReplacementRemoveButton, NilAddButton, NilRemoveButton, RetrunToVoiceAddButton, RetrunToVoiceRemoveButton, RoadsideAssistanceAddButton, RoadsideAssistanceRemoveButton, SecureTowingAddButton, SecureTowingRemoveButton, TyreAddButton, TyreRemoveButton, TotalPremiumComprehensive, FiveComprehensiveTxt, thirdComprehensiveTxt, StandardPlanPremium, StandardPlanPremiumTxt, TPTextView, TotalPremiumTp, OneYearComprehensiveTxt, ManufacturePriceButton, ManufacturePriceRemoveButton, DrivingTrainProtectAddButton, DrivingTrainProtectRemoveButton;
    EditText IDVEdit, MemberEditTxt, ValidityTxt, addOnsEdit, addCoveragesEdit, basicPremium, VehicleModelEdit, YearEdit, DiscountEdit, gstEdit, BasicODEdit, BasicTpEdit, totalAmount, TotalDiscountEdit, NCBEdit;
    Button buttonClose, SubmitIDvBtn;
    final Calendar myCalendar = Calendar.getInstance();
    DatePickerDialog datePicker;
    int day, year, month, selectYear, daysLeft,VehicleAgeAdd,MonthsLeft;
    private MySharedPreference pref;
    Date date, date1, date3;
    Format formatter;
    String strGenderSpinner = "",streditdob="",strIDType="",strIDTypeName="",strIDNumberEdit="";
    ...
    CardView AntitheftdeviceCardView, AutomobileCardView, TPPDCardView, VotaryCardView, HandicapDiscountCardView, WrongFuelCardView, DailCashAllownceCardView, BasicODCardView, BasicTPCardView, ElectricalCardView, FIBERTANKODCardView, LegalLiabilityCardView, NonLegalLiabilityCardView, OtherOdCardView, OtherTpCardView, EMPLOYEESCardView, OwnerDriverCardView, CngStatusCardView, CNGLPGKITTPStatusCardView, BUILTINCNGKITCardView, BuiltinCngLPGTpCardView, ManufacturePriceSellingCardView, PaidDriverCardView, PASSENGERSCardView, UnnamedPassengerCardView, AccidentalCardView, CostOfCardView, DailyCashCardView, DailyCardView, EngineProtectorCardView, EngineCardView, HydrostaticeCardView, KeyReplacementCardView, NilCardView, ReturnToInvoiceCardView, RoadsideAssistanceCardView, SecureTowingCardView, TyreCardView, DrivingTrainProtectCardView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_old_motor_add_ons);
        pref = MySharedPreference.getInstance(OldMotorAddOns.this);
        getWindow().setStatusBarColor(ContextCompat.getColor(OldMotorAddOns.this, R.color.colorPrimaryDark));
        customprogress = new CustomProgressDialog(OldMotorAddOns.this);
...
//        }
    ...
    private void initView() {
        TPLiner = findViewById(R.id.TPLiner);
        IDVEdit = findViewById(R.id.IDVEdit);
        RecommendTxt = findViewById(R.id.RecommendTxt);
        relativeComp = findViewById(R.id.relativeComp);
        relativeThird = findViewById(R.id.relativeThird);
        OwnDamagedLiner = findViewById(R.id.OwnDamagedLiner);
        ...
        clcikTpTxt = findViewById(R.id.clcikTpTxt);
        clcikODTxt = findViewById(R.id.clcikODTxt);
        ...
        if (strVehicleTypeRadio.equals("Four Wheeler")) {
            TxtViewVehicleType.setText("Four Wheeler Insurances");
            OneYearComprehensiveRadio.setText("1 year OD + 1year TP ");
            imgeBike.setBackgroundResource(R.drawable.fourwheelerimg);
            Drawable thumb = ContextCompat.getDrawable(OldMotorAddOns.this, R.drawable.car_seekbar);
            ...
            Drawable thumb = ContextCompat.getDrawable(OldMotorAddOns.this, R.drawable.bike_motor_seekbar);
            seekBarDistance.setThumb(thumb);
        }
        ...
        clcikTpTxt.startAnimation(anim);
        clcikODTxt.startAnimation(anim);
        strFor = strNewFor;
        if (!(strVehicleNo.equals("")||strVehicleNo.equals("New"))){
            strVehicleCubicCapicity = rc_cubic_cap;
        }
        ageVehicle = Integer.parseInt(strVehicleAge);


        if (!StrPreviousPolicyRadio.equals("No") && VehicleAgeAdd<3){
            try {
                SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
                strTpEndDate = sdf.parse(strTpFromDateEdit);
...
//            strEndDate = sdf.parse(strEndDateEdit);
//            long difference = Math.abs(strTpEndDate.getTime() - strEndDate.getTime());
//            long differenceDates = difference / (24 * 60 * 60 * 1000);
//            dayDifference = Integer.parseInt(Long.toString(differenceDates));
//        } catch (ParseException e) {
//            e.printStackTrace();
//        }
            ...
            if (strVehicleTypeRadio.equals("Four Wheeler")) {
                ...
                if (VehicleAgeAdd <3) {
                    if (!StrPreviousPolicyRadio.equals("No")){
                        if (strEndDateEdit.equals(strTpFromDateEdit)){
                            comprehensiveMethod();
                            OneYearComprehensiveRadio.setChecked(true);
                            OneYearStandardAloneRadio.setChecked(false);
                            relativeComp.setVisibility(View.VISIBLE);
                            RecommendTxt.setVisibility(View.VISIBLE);
                            OwnDamagedLiner.setVisibility(View.GONE);
                            relativeThird.setVisibility(View.GONE);
                            TPLiner.setVisibility(View.VISIBLE);

                        }
                        else if (strEndDate.getTime()>strTpEndDate.getTime()){
                            comprehensiveMethod();
                            OneYearComprehensiveRadio.setChecked(true);
                            OneYearStandardAloneRadio.setChecked(false);
                            relativeComp.setVisibility(View.VISIBLE);
                            ...
                            relativeComp.setVisibility(View.VISIBLE);
                            RecommendTxt.setVisibility(View.VISIBLE);
                            OwnDamagedLiner.setVisibility(View.VISIBLE);
                            relativeThird.setVisibility(View.GONE);
                            TPLiner.setVisibility(View.VISIBLE);
                        }
                    }
                    ...
                    relativeComp.setVisibility(View.VISIBLE);
                    RecommendTxt.setVisibility(View.VISIBLE);
                    relativeThird.setVisibility(View.VISIBLE);
            ...
            if (strVehicleTypeRadio.equals("Four Wheeler")) {
                ...
                if (VehicleAgeAdd <3) {
                    ...
                    if(strPlanType.equals("Comprehensive")){
                        ...
                        comprehensiveMethod();
                        IDVLinear.setVisibility(View.VISIBLE);
                    }else if(strPlanType.equals("Liability")){
                        TPLiner.setVisibility(View.GONE);
                        IDVLinear.setVisibility(View.GONE);
                        ThirdPartyMethod();
                    }
            ...
            if (CheckString.equals("1")) {
                ...
                if (VoluntarydeductableStatus.equals("True")){
                    ...
                    if (strVehicleTypeRadio.equals("Four Wheeler")) {
                        ...
                        if (VoluntarydeductableSumInsured.equals("2500")){
                        ...
                        }else if  (VoluntarydeductableSumInsured.equals("5000")){
                            VotaryPrivateTwoFiveButton.setChecked(false);
                            VotaryPrivateFiveButton.setChecked(true);
                            VotaryPrivateSevenFiveButton.setChecked(false);
                            VotaryPrivateOneFiveButton.setChecked(false);
                        }else if  (VoluntarydeductableSumInsured.equals("7500")){
                            VotaryPrivateTwoFiveButton.setChecked(false);
                            VotaryPrivateFiveButton.setChecked(false);
                            VotaryPrivateSevenFiveButton.setChecked(true);
                            VotaryPrivateOneFiveButton.setChecked(false);
                        }else if  (VoluntarydeductableSumInsured.equals("15000")){
                            VotaryPrivateTwoFiveButton.setChecked(false);
                            VotaryPrivateFiveButton.setChecked(false);
                            VotaryPrivateSevenFiveButton.setChecked(false);
                        ...
                        if (VoluntarydeductableSumInsured.equals("500")){
                            ...
                            VotaryPrivateSevenFiveButton.setChecked(false);
                            VotaryPrivateOneFiveButton.setChecked(false);
                        }else if (VoluntarydeductableSumInsured.equals("750")){
                            ...
                            VotaryPrivateSevenFiveButton.setChecked(false);
                            VotaryPrivateOneFiveButton.setChecked(false);
                        }else if (VoluntarydeductableSumInsured.equals("1000")){
                            ...
                            VotaryPrivateSevenFiveButton.setChecked(false);
                            VotaryPrivateOneFiveButton.setChecked(false);
                        }else if (VoluntarydeductableSumInsured.equals("1500")){
                            ...
                            VotaryPrivateSevenFiveButton.setChecked(false);
                            VotaryPrivateOneFiveButton.setChecked(false);
                        }else if (VoluntarydeductableSumInsured.equals("3000")){
        ...
        OneYearComprehensiveRadio.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (OneYearComprehensiveRadio.isChecked()) {
                    ...
                    TPLiner.setVisibility(View.VISIBLE);
                    strPlanType = "Comprehensive";
//                    AntitheftdevicediscountStatus1 = "True";
                    AntitheftdevicediscountStatus1 = "False";
//                    AutomobileAssociationdiscountStatus1 = "True";
                    AutomobileAssociationdiscountStatus1 = "False";
                    VoluntarydeductableStatus1 = "True";
//                    TPPDDiscountStatus1 = "True";
                    TPPDDiscountStatus1 = "False";
//                    HandicapDiscountStatus1 = "True";
                    HandicapDiscountStatus1 = "False";
                    IDVLinear.setVisibility(View.VISIBLE);
                    Calendar calendar = Calendar.getInstance();
                    date = calendar.getTime();
                    formatter = new SimpleDateFormat("dd/MM/yyyy");
        ...
        OneYearThirdPartyRadio.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (OneYearThirdPartyRadio.isChecked()) {
                    ...
                    AntitheftdevicediscountStatus1 = "False";
                    AutomobileAssociationdiscountStatus1 = "False";
                    VoluntarydeductableStatus1 = "False";
                    TPPDDiscountStatus1 = "True";
                    HandicapDiscountStatus1 = "False";
                    ...
                    HYDROSTATICLOCKCOVERStatus1 = "False";
                    ...
                    DRIVINGTRAINPROTECTStatus1 = "False";
                    WRONGFUELCOVERStatus1 = "False";
                    DetariffLoadingStatus1 = "False";
                    DetariffDiscountStatus1 = "False";
                    DAILYCASHALLOWANCEStatus1 = "False";
                    LEGALLIABILITYTOPAIDDRIVERStatus1 = "False";
                    ELECTRICALACCESSORYODStatus1 = "False";
                    NONELECTRICALACCESSORYODStatus1 = "False";
...
//                            VehicleMotorAddOnsQuotation();
                            ...
                            Toast.makeText(OldMotorAddOns.this, "IDV must be between min IDV and max IDV", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(OldMotorAddOns.this, "Can't Take Addons because idv is 0", Toast.LENGTH_SHORT).show();
        ...
        seekBarDistance.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    ...
                    strIdvValueTxtSelect = String.valueOf(progressChanged);
                    IDVTotalPremium.setText(strIdvValueTxtSelect);
        ...
        ElectricalCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (ElectricalCheckBox.isChecked()) {
                    Dialog alert_dialog;
                    alert_dialog = new Dialog(OldMotorAddOns.this);
                    ...
                    electricalAccessoriesBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (strElectricalAccessoriesSumInsured.equals("")) {
                                Toast.makeText(OldMotorAddOns.this, "Enter Value (Limit max 40% of IDV)", Toast.LENGTH_SHORT).show();
                                ELECTRICALACCESSORYODStatus = "False";
                                ElectricalCheckBox.setChecked(false);
                            } else {
                                if (Double.parseDouble(strElectricalAccessoriesSumInsured) > MathRound) {
                                    Toast.makeText(OldMotorAddOns.this, "Limit max 40% of IDV", Toast.LENGTH_SHORT).show();
                                    ELECTRICALACCESSORYODStatus = "False";
                                    ElectricalCheckBox.setChecked(false);
                                } else {
...
//                                        Toast.makeText(OldMotorAddOns.this, "Limit Up-To min 1000 and max 40% of IDV", Toast.LENGTH_SHORT).show();
//                                        ELECTRICALACCESSORYODStatus = "False";
//                                        ElectricalCheckBox.setChecked(false);
//                                    } else {
//                                        ELECTRICALACCESSORYODStatus = "True";
...
//                VehicleMotorAddOnsQuotation();
        ...
        ViewDetails.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Dialog alert_dialog = new Dialog(OldMotorAddOns.this);
                alert_dialog.setCanceledOnTouchOutside(false);
                alert_dialog.setCancelable(false);
                alert_dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                Objects.requireNonNull(alert_dialog.getWindow()).setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                ...
                gstEdit.setText(GST);
                if (!(strPlanType.equals("Comprehensive") || strPlanType.equals("Own damage (standalone)"))) {
                    StrAdditionalCoverPremiumOD = "0.0";
                }
                ...
                if (strDiscountEdit.equals("")){
                    strDiscountEdit="0.00";
                }
                if (StrNCB.equals("")){
                    StrNCB="0.00";
                }
        ...
        AddOnsBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OldMotorAddOns.this, Add_Details_Old_Vehicle.class);
...
//            intent.putExtra("strTpPlanEndDateEdit",strTpPlanEndDateEdit);
        ...
        continue_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                strContineuBtn = "True";
                Intent intent = new Intent(OldMotorAddOns.this, Motor_vehicle_details.class);
    ...
    private void OwnDamagedTwoWheelerMethod() {
        strPlanType = "Own damage (standalone)";
        strPlanYear = "1 Year";
        ProductName = "TWO WHEELER - OD";
        ProductCode = "2397";
...
//      HandicapDiscountStatus1 = "True";
    ...
    private void comprehensiveTwoWheelerMethod() {
        strPlanType = "Comprehensive";
        strPlanYear = "1 Year";
        ProductName = "TWO WHEELER PACKAGE POLICY";
        ProductCode = "2312";
...
//      HandicapDiscountStatus1 = "True";
    ...
    private void ThirdPartyTwowheelerMethod() {
        strPlanType = "Third Party";
        strPlanYear = "1 Year";
        ProductName = "TWO WHEELER LIABILITY POLICY";
        ProductCode = "2320";
    ...
    private void comprehensiveMethod() {
        strPlanType = "Comprehensive";
        strPlanYear = "1 Year";
        ProductName = "PRIVATE CAR PACKAGE POLICY";
        ProductCode = "2311";
...
//      HandicapDiscountStatus1 = "True";
        HandicapDiscountStatus1 = "False";
        relativeComp.setVisibility(View.GONE);
        RecommendTxt.setVisibility(View.GONE);
        relativeThird.setVisibility(View.GONE);
        OwnDamagedLiner.setVisibility(View.VISIBLE);
        TPLiner.setVisibility(View.VISIBLE);
        OneYearStandardAloneRadio.setChecked(true);
    ...
    private void dialogCNG() {
        CNGalert_dialog = new Dialog(OldMotorAddOns.this);
        ...
        CngKitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (strCngKitSumInsured.equals("")){
                    Toast.makeText(OldMotorAddOns.this, "Enter Value (Limit Up-To min 1000 and max 40% of IDV)", Toast.LENGTH_SHORT).show();
                    CNGLPGKITODStatus="False";
                    CNGLPGKITTPStatus="False";
                    CNGLPGKITODCheckBox.setChecked(false);
                    CNGLPGKITTPCheckBox.setChecked(false);
...
//                        VehicleMotorAddOnsQuotation();
    ...
    private void addOnsShow() {
        if (strVehicleTypeRadio.equals("Four Wheeler")) {
            if (FuleType.equalsIgnoreCase("Petrol")) {
                ...
                BUILTINCNGKITCheckBox.setChecked(false);
                BuiltinCngLPGTpCheckBox.setChecked(false);
                if (strPlanType.equals("Own damage (standalone)")){
                    CNGLPGKITTPStatus1 = "False";
                }
            }
            else if (FuleType.equalsIgnoreCase("LPG") || FuleType.equalsIgnoreCase("CNG")) {
            ...
            if (str_vehicleManufacturerNm.equals("MARUTI") || str_vehicleManufacturerNm.equals("MARUTI SUZUKI") || str_vehicleManufacturerNm.equals("MARUTI SUZUKI INDIA LTD")) {
                ...
                else if (ageVehicle > 5 && ageVehicle <= 10) {
                    BasicODStatus = "True";
                    BasicTP = "True";
                    PACOVERTOEMPLOYEESOFINSUREDStatus1 = "True";
                    PACOVERTOPASSENGERSStatus1 = "True";
                ...
                if (strPlanType.equals("Own damage (standalone)")){
                    LEGALLIABILITYTOPAIDDRIVERStatus1 = "False";
                    PACOVERTOEMPLOYEESOFINSUREDStatus1 = "False";
                    PACOVERTOPASSENGERSStatus1 = "False";
                    PACOVERTOPAIDDRIVERStatus1 = "False";
                    UNNAMEDPACOVERTOPASSENGERSStatus1 = "False";
                    PACOVERTOOWNERDRIVERStatus1 = "False";
                }
                VehicleMotorAddOnsQuotation();
            }
                ...
                if (ageVehicle <= 5) {
                    ...
                    RoadsideAssistanceStatus1 = "False";
                    NilDepreciationWaivercoverStatus1 = "True";
                    DAILYCASHALLOWANCENONMETROStatus1 = "True";
                    DAILYCASHALLOWANCEMETROStatus1 = "True";
                ...
                else if (ageVehicle > 5 && ageVehicle <= 7) {
                    BasicODStatus = "True";
                    BasicTP = "True";
                    PACOVERTOEMPLOYEESOFINSUREDStatus1 = "True";
                    PACOVERTOPASSENGERSStatus1 = "True";
                ...
                else if (ageVehicle > 7 && ageVehicle <= 10) {
                    BasicODStatus = "True";
                    BasicTP = "True";
                    PACOVERTOEMPLOYEESOFINSUREDStatus1 = "True";
                    PACOVERTOPASSENGERSStatus1 = "True";
                ...
                if (ageVehicle <= 5) {
                    ...
                    KEYREPLACEMENTStatus1 = "True";
                    RETURNTOINVOICEStatus1 = "True";
                    ACCIDENTALHOSPITALIZATIONStatus1 = "True";
                    HYDROSTATICLOCKCOVERStatus1 = "True";
                    COSTOFCONSUMABLESStatus1 = "True";
                    SECURETOWINGStatus1 = "True";
                    TyreandRimsecureStatus1 = "True";
    ...
    private void updateLabel() {
        ...
        DatePickerDialog datePicker = new DatePickerDialog(OldMotorAddOns.this, R.style.DialogTheme, (view, year, monthOfYear, dayOfMonth) -> {
...
//    datePicker.getDatePicker().setMaxDate(System.currentTimeMillis());
    ...
    private void VehicleMotorAddOnsQuotation() {
        ...
        if (strPlanType.equals("Comprehensive")) {
            ELECTRICALACCESSORYODStatus1 = "True";
            NONELECTRICALACCESSORYODStatus1 = "True";
        }else if (strPlanType.equals("Own damage (standalone)")){
            CNGLPGKITTPStatus1 = "False";
            ELECTRICALACCESSORYODStatus1 = "True";
            NONELECTRICALACCESSORYODStatus1 = "True";
...
//            VoluntarydeductableSumInsured = "500";
        ...
        try {
            ...
            object.put("ELECTRICALACCESSORYODStatus", ELECTRICALACCESSORYODStatus1);
            object.put("ELECTRICALACCESSORYODSumInsured", "1000");
            object.put("NONELECTRICALACCESSORYODStatus", NONELECTRICALACCESSORYODStatus1);
            ...
            object.put("PACOVERTOPASSENGERSStatus", PACOVERTOPASSENGERSStatus1);
            object.put("PACOVERTOPASSENGERSSumInsured", "50000");
            object.put("PACOVERTOPAIDDRIVERStatus", PACOVERTOPAIDDRIVERStatus1);
            object.put("PACOVERTOPAIDDRIVERSumInsured", "50000");
            object.put("OtherTPStatus", OtherTpStatus1);
            object.put("FIBERTANKODStatus", FIBERTANKODStatus1);
            object.put("OtherODStatus", OtherODStatus1);
            object.put("UNNAMEDPACOVERTOPASSENGERSStatus", UNNAMEDPACOVERTOPASSENGERSStatus1);
            object.put("UNNAMEDPACOVERTOPASSENGERSSumInsured", "50000");
            object.put("PACOVERTOOWNERDRIVERStatus", PACOVERTOOWNERDRIVERStatus1);
            ...
            object.put("LEGALLIABILITYTOPAIDDRIVERStatus", LEGALLIABILITYTOPAIDDRIVERStatus1);
            object.put("RoadsideAssistanceStatus", RoadsideAssistanceStatus1);
            ...
            object.put("DetariffLoadingStatus", DetariffLoadingStatus1);
            object.put("DetariffDiscountStatus", DetariffDiscountStatus1);
            object.put("DAILYCASHALLOWANCEStatus", DAILYCASHALLOWANCEStatus1);
            object.put("AntitheftdevicediscountStatus", AntitheftdevicediscountStatus1);
            object.put("AntitheftdevicediscountSumInsured", "");
            object.put("AutomobileAssociationdiscountStatus", AutomobileAssociationdiscountStatus1);
            object.put("AutomobileAssociationdiscountSumInsured", "");
            object.put("VoluntarydeductableStatus", VoluntarydeductableStatus1);
            object.put("VoluntarydeductableSumInsured", VoluntarydeductableSumInsured);
            object.put("TPPDDiscountStatus", TPPDDiscountStatus1);
            object.put("TPPDDiscountSumInsured", "6000");
            object.put("HandicapDiscountStatus", HandicapDiscountStatus1);
            ...
            object.put("VoluntarydeductableDiscountAmount", VoluntarydeductableSumInsured);

        } catch (Exception e) {
            e.printStackTrace();
        }
        ProjectVolleyRequest req = new ProjectVolleyRequest(OldMotorAddOns.this, object, UrlConstants.BUY_VehicleMotorQuotation, new ResponseListener() {
            @Override
...
//                                                TPPDCardView.setVisibility(View.VISIBLE);
    ...
    private void errorBack() {
        Intent intent = new Intent(OldMotorAddOns.this, MotorPrivate.class);
        intent.putExtra("strVehicleNo", strVehicleNo);
        intent.putExtra("strGenderSpinner",strGenderSpinner);
        intent.putExtra("streditdob",streditdob);
        intent.putExtra("strIDType",strIDType);
...
//                                     }
    ...
    private void saveGetQuote() {
        ...
        ProjectVolleyRequest req = new ProjectVolleyRequest(OldMotorAddOns.this, object, UrlConstants.BUYSaveQuotationDetails, new ResponseListener() {
            @Override
            public void onSuccess(JSONObject object, int Tag) {
                if (object.optString("Message").equals("Success")) {
                    final Dialog alert_dialog = new Dialog(OldMotorAddOns.this);
