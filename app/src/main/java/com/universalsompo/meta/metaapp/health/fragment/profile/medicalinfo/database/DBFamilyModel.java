...
public class DBFamilyModel {
    public static final String TABLE_NAME = "family_medical_history";
    ...
    public DBFamilyModel(){}

    public DBFamilyModel(String user_id, String diseases_id, String diseases_name, String is_user_suffer){
    ...
    public DBFamilyModel(String diseases_id, String diseases_name, String is_user_suffer){
        this.diseases_id = diseases_id;
        this.diseases_name = diseases_name;
        this.is_user_suffer = is_user_suffer;
    }
