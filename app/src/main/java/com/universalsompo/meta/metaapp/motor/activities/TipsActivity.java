...
public class TipsActivity extends Activity {
    private TextView benefit_title;
    private LinearLayout cross_icon;
    private WebView inapp_browser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inapp_browser = findViewById(R.id.inapp_browser);
        ...
        inapp_browser.setWebViewClient(new WebViewClient() {
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                Toast.makeText(TipsActivity.this, description, Toast.LENGTH_SHORT).show();
            }
        });

        inapp_browser .loadUrl(getIntent().getStringExtra("url"));
        TipsActivity.WebClientClass webViewClient = new TipsActivity.WebClientClass();
    ...
    public class WebClientClass extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            pd = new SpotsDialog(TipsActivity.this , R.style.Custom);
            pd.show();
        }
