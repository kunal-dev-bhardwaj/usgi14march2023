...
import com.universalsompo.meta.metaapp.health.fragment.profile.medicalinfo.adapter.FamilyHistoryAdapter;
import com.universalsompo.meta.metaapp.health.fragment.profile.medicalinfo.database.DBFamilyModel;
...
public class FragmentFamilyHistory extends Fragment implements ResponseListener {
    private View v;
    private SelectorListener binder;
    private ListView list;
    private TextView no_data;
    private FamilyHistoryAdapter familyhistoryAdapter;
    ArrayList<FamilyHistoryModel> data = new ArrayList<>();
    private MySharedPreference mySharedPreference;
    private DatabaseHelperFamily db;
    private List<DBFamilyModel> userHistorylist;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fragment_family_history, container,false);
    ...
    private void init() {
        ...
        getActivity().deleteDatabase("family_medical_history_db");
        db = new DatabaseHelperFamily(getActivity());
        getfamilyhistory1();
        getfamilyhistory();
    ...
    private void getfamilyhistory1() {
    ...
    public void responsebuilder(){
        ...
        for (DBFamilyModel cn : userHistorylist) {
        ...
        if (Tag == RequestHealthConstants.GET_MEDICAL_HISTORY){
            if (object.optString("Message").equals("Success")) {
                ...
                try {
                    ...
                    familyhistoryAdapter = new FamilyHistoryAdapter(getActivity(), data);
                    list.setAdapter(familyhistoryAdapter);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                try {
