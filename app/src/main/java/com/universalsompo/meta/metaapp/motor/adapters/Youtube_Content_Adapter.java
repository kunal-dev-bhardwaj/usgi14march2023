...
public class Youtube_Content_Adapter extends RecyclerView.Adapter<Youtube_Content_Adapter.MyViewHolder> {
    ...
    public Youtube_Content_Adapter(Context mContext, List<ContentModel> listModelJobsInfo) {
