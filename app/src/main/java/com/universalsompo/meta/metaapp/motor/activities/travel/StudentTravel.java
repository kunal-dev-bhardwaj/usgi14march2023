...
public class StudentTravel extends Fragment {
    String StudentTravelUrl="https://www.universalsompo.com/OverseasTravel/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_student_travel, container, false);
        ...
        myWebView.setWebChromeClient(new StudentTravel.MyWebViewClient());
        ...
        myWebView.loadUrl(StudentTravelUrl);
        myWebView.setWebViewClient(new WebViewClient() {
            @Override
