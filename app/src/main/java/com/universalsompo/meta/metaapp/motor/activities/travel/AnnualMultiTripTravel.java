...
public class AnnualMultiTripTravel extends Fragment {
    String AnnualTripURL="https://www.universalsompo.com/OverseasTravel/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_annual_multi_trip_travel, container, false);
        ...
        myWebView.setWebChromeClient(new AnnualMultiTripTravel.MyWebViewClient());
        ...
        myWebView.loadUrl(AnnualTripURL);
        myWebView.setWebViewClient(new WebViewClient() {
            @Override
