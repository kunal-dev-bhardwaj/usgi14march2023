...
import com.universalsompo.meta.metaapp.health.fragment.reminders.alarmservices1.walk.WalkJobService;
import com.universalsompo.meta.metaapp.health.fragment.reminders.database.WalkTypeDatasbaseHelper;
import com.universalsompo.meta.metaapp.motor.sharedpreferences.MySharedPreference;

public class WorkOutJobService extends JobIntentService {
    ...
    public static void enqueueWork(Context context, Intent intent) {
        enqueueWork(context, WorkOutJobService.class, JOB_ID, intent);
    }

    @Override
    protected void onHandleWork(@NonNull Intent intent) {
        pref = MySharedPreference.getInstance(WorkOutJobService.this);
        db = new WalkTypeDatasbaseHelper(WorkOutJobService.this);
        ...
        if (pref.getNotificationOnOrOff()) {
            ...
            String notificationText = "Every workout counts even if it’s only for 15 minutes. Just do it!";
            NotificationCompat.Builder builder = new NotificationCompat.Builder(WorkOutJobService.this,CHANNEL_ID)
                    .setAutoCancel(true)
                    ...
                    .setContentIntent(PendingIntent.getActivity(WorkOutJobService.this, 2000, new Intent(WorkOutJobService.this, MainActivityHealth.class), PendingIntent.FLAG_UPDATE_CURRENT));
            if (pref.getNotificationSound()){
                builder.setDefaults(Notification.DEFAULT_SOUND);
            }
            NotificationManager notificationManager = (NotificationManager) WorkOutJobService.this.getSystemService(WalkJobService.NOTIFICATION_SERVICE);
    ...
    void toast(final CharSequence text) {
        mHandler.post(new Runnable() {
            @Override public void run() {
                Toast.makeText(WorkOutJobService.this, text, Toast.LENGTH_SHORT).show();
            }
        });
    }
