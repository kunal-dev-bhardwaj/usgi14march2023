...
import com.universalsompo.meta.metaapp.health.fragment.myissues.fragment.FragmentMyIssueDetails;
...
public class MyIssueAdapter extends BaseAdapter {
    ...
    private List<MyIssues> issue_list;
    private String issue_id, category1, desc;

    public MyIssueAdapter(Activity activity, List<MyIssues> help) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null)
            view = inflater.inflate(R.layout.my_issue_list_layout, viewGroup, false);
        ...
        final MyIssues m = issue_list.get(i);
        ...
        my_issue_selected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                desc = m.getComment();
                Fragment frag = new FragmentMyIssueDetails();
                Bundle args = new Bundle();
                args.putString("issue_id", issue_id);
                args.putString("cat", category1);
                args.putString("desc", desc);
                frag.setArguments(args);
                FragmentsTransactionsUtils.replaceFragmentKeepPrevious(activity, frag, R.id.main_frame1, FragmentsHealthTags.FRAGMENT_MY_ISSUE);
            }
        });
        return view;
    }
