...
import com.universalsompo.meta.metaapp.health.fragment.help.fragment.FragmentHelp2;
...
public class Help1Adapter extends BaseAdapter implements ResponseListener {
    private Activity activity;
    private LayoutInflater inflater;
    private List<Help> help_list;
    private String id_help1;
    private String id_category;
    private String name_category;

    public Help1Adapter(Activity activity, List<Help> help, String Id_help) {
    ...
    private void callApi(String mId) {
        ...
        ProjectVolleyRequest req = new ProjectVolleyRequest(activity, object, UrlHealthConstants.GET_HELP2, this, RequestHealthConstants.GET_HELP2);
        req.execute();
    }

    @Override
    public void onSuccess(JSONObject object, int Tag) {
        if (Tag == RequestHealthConstants.GET_HELP2) {
            if (object.optString("Message").equals("Success")) {
                Fragment frag = new FragmentHelp2();
                Bundle args = new Bundle();
                args.putString("name", name_category);
                args.putString("id_help1", id_help1);
                args.putString("id_help2", id_category);
