...
public class TravelAsia extends Fragment {
    String TravelAsiaUrl="https://www.universalsompo.com/OverseasTravel/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_travel_asia, container, false);
        ...
        myWebView.setWebChromeClient(new TravelAsia.MyWebViewClient());
        ...
        myWebView.loadUrl(TravelAsiaUrl);
        myWebView.setWebViewClient(new WebViewClient() {
            @Override
