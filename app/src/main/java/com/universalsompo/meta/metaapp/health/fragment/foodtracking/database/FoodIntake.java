...
public class FoodIntake {
    public static final String TABLE_NAME = "diet_intake";
        ...
        public FoodIntake(int id, String user_id, String meal_type, String food_name, String calories, String carbs,  String fat, String protein){
            this.id = id;
        ...
        public FoodIntake(int id, String user_id, String meal_type, String food_name, String calories, String carbs,  String fat, String protein, String date, String food_id, String food_nutrition, String quantity){
            this.id = id;
            this.user_id = user_id;
            this.meal_type = meal_type;
            this.food_name = food_name;
