...
import static com.universalsompo.meta.metaapp.utilities.BubbleUtils.dp2px;
import static com.universalsompo.meta.metaapp.utilities.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMax = a.getFloat(R.styleable.BubbleSeekBar_bsb_max, 150.0f);
        ...
        mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color,
                ContextCompat.getColor(context, R.color.lightblack));
