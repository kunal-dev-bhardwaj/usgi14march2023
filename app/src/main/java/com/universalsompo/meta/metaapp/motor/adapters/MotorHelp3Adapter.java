...
public class MotorHelp3Adapter extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<MotorHelp> help_list;
    private String id_help1, id_help2, id_help3;

    public MotorHelp3Adapter(Activity activity, List<MotorHelp> help, String Id_help, String Id_help1, String Id_help2) {
