...
import com.universalsompo.meta.metaapp.motor.fragments.FragmentMotorHelp2;
...
public class MotorHelp1Adapter extends BaseAdapter implements ResponseListener {
    ...
    public MotorHelp1Adapter(Activity activity, List<MotorHelp> help, String Id_help) {
    ...
    private void callApi(String mId) {
        ...
        ProjectVolleyRequest req = new ProjectVolleyRequest(activity, object, UrlConstants.GET_HELP2, this, RequestConstants.GET_HELP2);
        req.execute();
    }
    ...
    public void onSuccess(JSONObject object, int Tag) {
        if (Tag == RequestConstants.GET_HELP2) {
            if (object.optString("Message").equals("Success")) {
                Fragment frag = new FragmentMotorHelp2();
