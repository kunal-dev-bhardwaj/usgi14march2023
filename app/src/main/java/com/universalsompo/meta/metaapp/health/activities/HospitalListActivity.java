...
public class HospitalListActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hospital_txt_list = findViewById(R.id.hospital_txt_list);
        ...
        city_list.setOnClickListener(v -> {
            if (cityList != null && cityList.size() > 0) {
                ...
                Toast.makeText(HospitalListActivity.this, "Please Select State First", Toast.LENGTH_SHORT).show();
            }
        });
        state_list.setOnClickListener(v -> {
            if (stateList != null && stateList.size() > 0) {
                ...
                Toast.makeText(HospitalListActivity.this, "Please Restart app", Toast.LENGTH_SHORT).show();
            }
        });
        hospital_txt_list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(HospitalListActivity.this,Hospital_active_nonactive.class);
                startActivity(intent);
            }
        });

        map_title.setText("Hospital");
        customDialog = CustomProgressDialog.getInstance(HospitalListActivity.this);
        ...
        if (requestCode == 2000) {
            switch (resultCode) {
                ...
                case Activity.RESULT_CANCELED:
                    Toast.makeText(HospitalListActivity.this, "Enabling GPS is mandatory", Toast.LENGTH_LONG).show();
                    finish();
                    break;
            }
        }
            ...
            public void onResult(LocationSettingsResult result) {
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            status.startResolutionForResult(HospitalListActivity.this, 2000);
    ...
    void startNearByPoint() {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                geocoder = new Geocoder(HospitalListActivity.this, Locale.getDefault());
                try {
...
//            }
    ...
    void getState() {
        ...
        ProjectVolleyRequest request = new ProjectVolleyRequest(HospitalListActivity.this, object, UrlConstants.GET_STATE, this, STATE_TAG);
        request.execute();
    }
    ...
    void getCity(String stateId) {
        ...
        ProjectVolleyRequest request = new ProjectVolleyRequest(HospitalListActivity.this, object, UrlConstants.GET_CITY_BASED_ON_NAME, this, CITY_TAG);
        request.execute();
    }
    ...
    void getCompanyList() {
        ...
        ProjectVolleyRequest request = new ProjectVolleyRequest(HospitalListActivity.this, object, UrlConstants.GET_COMAPANY_LIST, this, COMAPNY_LIST_TAG);
        request.execute();
    }
    ...
    void getVehicle() {
        ...
        ProjectVolleyRequest request = new ProjectVolleyRequest(HospitalListActivity.this, object, UrlConstants.GET_VEHICLE, this, VEHICLE_TAG);
        request.execute();
    }
    ...
    void popUpForStateList() {
        final AdapterFilter adapter = new AdapterFilter(HospitalListActivity.this, stateList);
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(HospitalListActivity.this);
        LayoutInflater inflater = HospitalListActivity.this.getLayoutInflater();
    ...
    void popUpForCityList() {
        final AdapterFilter adapter = new AdapterFilter(HospitalListActivity.this, cityList);
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(HospitalListActivity.this);
        LayoutInflater inflater = HospitalListActivity.this.getLayoutInflater();
        View dialogView = inflater.inflate(R.layout.claim_map_filter_screen, null);
        final EditText tv = dialogView.findViewById(R.id.inputSearch);
    ...
    void popUpForvehicleList() {
        ...
        final AdapterFilter adapter = new AdapterFilter(HospitalListActivity.this, vehivleList);
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(HospitalListActivity.this);
        LayoutInflater inflater = HospitalListActivity.this.getLayoutInflater();
        View dialogView = inflater.inflate(R.layout.claim_map_filter_screen, null);
        final EditText tv = dialogView.findViewById(R.id.inputSearch);
    ...
    void popUpForCompanyList() {
        final AdapterFilter adapter = new AdapterFilter(HospitalListActivity.this, companyList);
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(HospitalListActivity.this);
        LayoutInflater inflater = HospitalListActivity.this.getLayoutInflater();
        View dialogView = inflater.inflate(R.layout.claim_map_filter_screen, null);
        final EditText tv = dialogView.findViewById(R.id.inputSearch);
    ...
    void getCompanyList(JSONObject object) {
        ProjectVolleyRequest request = new ProjectVolleyRequest(HospitalListActivity.this, object, UrlConstants.GET_ALL_Hospital, this, GARAGE_LIST_TAG);
        request.execute();
    }
    ...
    void initGarageList(JSONObject object) {
        ...
        if (object.optString("Message").equals("Success")) {
            IconGenerator generator = new IconGenerator(HospitalListActivity.this);
            generator.setBackground(null);
            String uri = "@drawable/new_pinpoint_icon";  // where myresource (without the extension) is the file
            int imageResource = getResources().getIdentifier(uri, null, getPackageName());
            ImageView iv = new ImageView(HospitalListActivity.this);
...
//        veh_type= Constants.TWO_WHEELER;
    ...
    private class FetchUrl extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            HospitalListActivity.ParserTask parserTask = new HospitalListActivity.ParserTask();
