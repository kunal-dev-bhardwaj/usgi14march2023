...
public class AyushPDFActivity extends AppCompatActivity {
    private static final String FILENAME = "ImmunityBoostingAYUSHAdvisory.pdf";
    PDFView ReadTxt;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ayush_pdf_opener_layout);
