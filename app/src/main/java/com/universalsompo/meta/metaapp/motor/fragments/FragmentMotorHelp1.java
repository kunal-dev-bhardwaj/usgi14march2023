...
import com.universalsompo.meta.metaapp.motor.adapters.MotorHelp1Adapter;
...
public class FragmentMotorHelp1 extends Fragment implements ResponseListener {
    private View v;
    private ListView select_issue1;
    private TextView no_data;
    private final ArrayList<MotorHelp> data = new ArrayList<>();
    private String name, id_help1;
    ...
    private void callApi() {
        ...
        try {
            ...
            object.put("CategoryID", id_help1);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ProjectVolleyRequest req = new ProjectVolleyRequest(getActivity(), object, UrlConstants.GET_HELP1, this, RequestConstants.GET_HELP1);
        req.execute();
    }

    @Override
    public void onSuccess(JSONObject object, int Tag) {
        if (Tag == RequestConstants.GET_HELP1){
            new AppDataPushApi().callApi(getActivity(),"Help","Help page","User facing problem in " + id_help1);
            if (object.optString("Message").equals("Success")){
                ...
                try {
                    ...
                    MotorHelp1Adapter helpAdapter = new MotorHelp1Adapter(getActivity(), data, id_help1);
