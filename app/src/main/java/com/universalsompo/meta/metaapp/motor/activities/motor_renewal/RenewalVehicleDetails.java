...
public class RenewalVehicleDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_renewal_vehicle_details);
        getWindow().setStatusBarColor(ContextCompat.getColor(RenewalVehicleDetails.this, R.color.colorPrimaryDark));
        ...
        vehicleDetailsBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(RenewalVehicleDetails.this,RenewalAddOns.class);
        ...
        continue_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(RenewalVehicleDetails.this,RenewalFinalMotor.class);
                intent.putExtra("VehiclePolicyHolderName",VehiclePolicyHolderName);
                intent.putExtra("VehiclePolicyNumber",VehiclePolicyNumber);
                intent.putExtra("VehicleManufactureYear",VehicleManufactureYear);
                intent.putExtra("VehicleNoOFDateLeft",VehicleNoOFDateLeft);
