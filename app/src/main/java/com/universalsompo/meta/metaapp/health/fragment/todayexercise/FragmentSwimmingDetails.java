...
public class FragmentSwimmingDetails extends Fragment implements ResponseListener {
    private View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fragment_swimming_details, container,false);
