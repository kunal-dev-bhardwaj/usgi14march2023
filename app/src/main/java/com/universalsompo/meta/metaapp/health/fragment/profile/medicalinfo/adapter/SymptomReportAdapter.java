...
public class SymptomReportAdapter extends RecyclerView.Adapter<SymptomReportAdapter.MyViewHolder> {
    ...
    public SymptomReportAdapter(Activity mContext, List<SymptomReportModel> symptomReportList) {
        this.mContext = mContext;
        this.symptomReportList = symptomReportList;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, final int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_symptom_report_list, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.hra_date.setText(symptomReportList.get(position).getDate());
        Doc_path = symptomReportList.get(position).getFilePath();
    ...
    private void startDownload(String Title, String url,String moto) {
        ...
        new SymptomReportAdapter.DownloadTask(Title,moto).execute(url);
    }
