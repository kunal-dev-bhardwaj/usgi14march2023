...
public class FatSecretSearch {
    ...
    final static private String APP_KEY = "fae2f0f9cc26468db46cce465ea012ec";
    static private String APP_SECRET = "c5c9cdf16c584584ac23599c74528409";
    ...
    public JSONObject searchFood(String searchFood, int page) {
        ...
        try {
            ...
            Log.e("food_url_test", String.valueOf(url));
