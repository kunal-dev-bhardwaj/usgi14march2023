...
public class FragmentDietDetail extends Fragment implements ResponseListener {
    private View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fragment_diary_diet_details, container, false);
                    ...
                    if (next.after(current)) {
                        ...
                        for (int i = 0; i < data.size(); i++) {
                            if (data.get(i).getDatee().equalsIgnoreCase(mdate1)) {
                                ...
                                tv_totalcalorystats.setText(TCAl);
    ...
    private void callApi() {
        ...
        try {
            object.put(RequestHealthConstants.TOKEN_NO_HEALTH, pref.getUID());
        ...
        ProjectVolleyRequest req = new ProjectVolleyRequest(getActivity(), object, UrlHealthConstants.GET_DIET_DIARY_DETAIL, this, RequestHealthConstants.GET_DIET_DIARY_DETAIL);
        req.execute();
    }
    ...
    public void onSuccess(JSONObject object, int Tag) {
        ...
        if (object.optString("Message").equalsIgnoreCase("Success")) {
            ...
            try {
                ...
                new AppDataPushApi().callApi(getActivity(),"Diary","Diet Diary","Checked for diet diary");
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else {
