...
public class CheckIfLoginNameExist extends AsyncTask<String, String, HashMap<String, String>> {
    Context mContext;
    private MySharedPreference pref;
    private ProgressDialog mProgressDialog;

    public CheckIfLoginNameExist(Context context) {
    ...
    protected void onPreExecute() {
        ...
        if (NetworkUtility.isOnline(mContext)) {
            ...
            mProgressDialog.setMessage("Initializing HRA...");
    ...
    protected HashMap<String, String> doInBackground(String... params) {
        ...
        if (!isCancelled()) {
            try {
                ...
                String strUrl ="https://core.allizhealthtest.in/Security/api/Account/CheckIfLoginNameExists";
                ...
                try{
                    ...
                    if(firstWord.contains(" ")){
                        ...
                        JSONData.put("LoginName", "ZOIK_" + firstWord + "123");
                    }
...
//            }
            if(resultMap!=null && resultMap.size()>0){
                ...
                String json_str2 = json_data1.getString("IsExist");
                if(json_str2.equalsIgnoreCase("False")){
                    CreatePersonAccount createaccount = new CreatePersonAccount(mContext,mProgressDialog);
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                        createaccount.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
                    } else {
                        createaccount.execute();
                    }
                } else {
                    String account_id1 = json_data1.getString("AccountID");
                    pref.setaccid(account_id1);
