...
public class TravelWorldwide extends Fragment {
    String TravelWorldURL="https://www.universalsompo.com/OverseasTravel/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_travel_worldwide, container, false);
        ...
        myWebView.setWebChromeClient(new TravelWorldwide.MyWebViewClient());
        ...
        myWebView.loadUrl(TravelWorldURL);
        myWebView.setWebViewClient(new WebViewClient() {
            @Override
