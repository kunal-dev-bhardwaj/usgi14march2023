...
public class NonExpired extends Fragment implements ResponseListener {
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_non_expired, container, false);
        rcv_bookedpolicy = v.findViewById(R.id.rv_booked_policyNon);
        shimmerIncludeLayout = v.findViewById(R.id.shimmerIncludeLayoutNon);
//        no_data= v.findViewById(R.id.no_data);
        mShimmerViewContainer = v.findViewById(R.id.parentShimmerLayoutNon);
                        ...
                        if (data1.size() != 0) {
                            if (day_left_to_expire < 1) {
                                ...
                                mShimmerViewContainer.postDelayed(() -> {
                                    ...
                                    ownPolicyAdapter1 = new MyPolicyAdapter(getActivity(), NonExpired.this, data1, prefrences);
